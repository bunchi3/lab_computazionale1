...
%Commentare le due figure e i risultati ottenuti.
%Attenzione che la figura 1422 non risponde tanto al punto (c) dell'esercizio, ma al punto (d). Va bene messo lì 
%perchè è la richiesta di (b), ma poi può essere commentato anche in (d).
