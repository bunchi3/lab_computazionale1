...
dato che miglioriamo l'approssimazione. In particolare la funzione $\Delta$ non è esattamente zero, perchè
l'approssimazione di Taylor richiede $N \rightarrow \infty$. Inoltre possiamo notare che la funzione $\Delta$, in ognuno
